...
HD_PWD='C:/PCAntigo/MyDriveD/Isel/SEADP/SEADPLAB/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_cell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_cell.tcl
