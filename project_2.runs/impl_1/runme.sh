...
HD_PWD='C:/PCAntigo/MyDriveD/Isel/SEADP/SEADPLAB/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_cell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_cell.tcl -notrace
